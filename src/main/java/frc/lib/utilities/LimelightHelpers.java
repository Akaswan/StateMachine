...
//     //   isPoseInField =
//     //       pose.getX() > 0 && pose.getX() < 16.51 && pose.getY() > 0 && pose.getY() < 8.17;
//     //   rotatingTooMuch = RobotContainer.m_drivebase.getPigeon().getRate() < 180;
//     //   movingTooFast =
//     //       RobotContainer.m_drivebase.getChassisSpeeds().vxMetersPerSecond < .6
//     //           && RobotContainer.m_drivebase.getChassisSpeeds().vyMetersPerSecond < .6;
