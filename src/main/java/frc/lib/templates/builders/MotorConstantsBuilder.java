...
public class MotorConstantsBuilder {
  ...
  public MotorConstantsBuilder withMotorControllerType(MotorControllerType type) {
    constants.kMotorControllerType = type;
    return this;
  }
  ...
  public MotorConstantsBuilder withIdleMode(IdleMode idleMode) {
    constants.kIdleMode = idleMode;
    return this;
  }
