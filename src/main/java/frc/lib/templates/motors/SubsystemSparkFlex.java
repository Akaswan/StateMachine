...
public class SubsystemSparkFlex implements SubsystemMotor {
  ...
  @Override
  public void configureMotor(MotorConstants constants, Supplier<Double> feedForward) {
  ...
  public void runToPosition(double position) {
    m_pidController.setReference(
        position, ControlType.kPosition, 0, m_feedForward.get(), ArbFFUnits.kVoltage);
  }

  @Override
  public void runToVelocity(double velocity) {
    m_pidController.setReference(
        velocity, ControlType.kVelocity, 0, m_feedForward.get(), ArbFFUnits.kVoltage);
  }
  ...
  public Command runToPositionWithProfile(
    ...
    return new ClosedLoopTrapezoidProfileCommand(
            ...
            (TrapezoidProfile.State state) -> {
              ...
              runToPosition(transitionState.getPosition());
            },
