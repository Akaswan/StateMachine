...
public final class Constants {
  ...
  public final class DriveConstants {
    ...
    public static final double kDrivebaseRadius = Math.sqrt((kTrackWidth * kTrackWidth) + (kWheelBase * kWheelBase));
    ...
    public static final double kFrontLeftOffset = 0.637451 ; // 0.719971; //0.597900; // In Rotations not degrees
    ...
    public static final double kFrontRightSteerOffset = 0.052979; //0.049561; // In Rotations not degrees
    ...
    public static final double kBackLeftSteerOffset = 0.502930  ; //0.504395 ; // In Rotations not degrees
    ...
    public static final double kBackRightSteerOffset = 0.832520 ; //0.829590 ;//0.834473; // In Rotations not degrees
