...
public class SubsystemStateContainer {
        ...
        public SubsystemStateContainer(SubsystemState armState, SubsystemState wristState, SubsystemState elevatorState) {
            m_armState = armState;
        ...
        public boolean equalTo(SubsystemStateContainer container) {
            if (container.getArmState() == m_armState && container.getWristState() == m_wristState && container.getElevatorState() == m_elevatorState) {
                return true;
            } else {
                return false;
            }
